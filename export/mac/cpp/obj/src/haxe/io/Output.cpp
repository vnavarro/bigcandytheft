...
{
		HX_STACK_PUSH("Output::writeString","/usr/lib/haxe/std/haxe/io/Output.hx",313);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(317)
...
{
		HX_STACK_PUSH("Output::writeFullBytes","/usr/lib/haxe/std/haxe/io/Output.hx",89);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
{
		HX_STACK_PUSH("Output::close","/usr/lib/haxe/std/haxe/io/Output.hx",68);
		HX_STACK_THIS(this);
	}
return null();
}
