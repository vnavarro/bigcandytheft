...
{
HX_STACK_PUSH("FlxSpriteFrames::new","org/flixel/system/layer/frames/FlxSpriteFrames.hx",10);
{
	HX_STACK_LINE(11)
	this->name = name;
	HX_STACK_LINE(12)
...
{
		HX_STACK_PUSH("FlxSpriteFrames::destroy","org/flixel/system/layer/frames/FlxSpriteFrames.hx",23);
		HX_STACK_THIS(this);
		HX_STACK_LINE(24)
		this->frames = null();
		HX_STACK_LINE(25)
...
Void FlxSpriteFrames_obj::addFrame( ::org::flixel::system::layer::frames::FlxFrame frame){
{
		HX_STACK_PUSH("FlxSpriteFrames::addFrame","org/flixel/system/layer/frames/FlxSpriteFrames.hx",17);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.layer.frames.FlxSpriteFrames"), hx::TCanCast< FlxSpriteFrames_obj> ,sStaticFields,sMemberFields,
