...
{
HX_STACK_PUSH("FlxList::new","org/flixel/system/FlxList.hx",33);
{
	HX_STACK_LINE(34)
	this->object = null();
	HX_STACK_LINE(35)
...
{
		HX_STACK_PUSH("FlxList::destroy","org/flixel/system/FlxList.hx",78);
		HX_STACK_THIS(this);
		HX_STACK_LINE(80)
		if ((!(this->exists))){
			HX_STACK_LINE(81)
...
::org::flixel::system::FlxList FlxList_obj::recycle( ){
	HX_STACK_PUSH("FlxList::recycle","org/flixel/system/FlxList.hx",43);
	HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("FlxList::clearCache","org/flixel/system/FlxList.hx",62);
		HX_STACK_LINE(64)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.FlxList"), hx::TCanCast< FlxList_obj> ,sStaticFields,sMemberFields,
