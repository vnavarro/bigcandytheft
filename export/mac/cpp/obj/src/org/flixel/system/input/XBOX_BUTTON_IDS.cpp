...
int XBOX_BUTTON_IDS_obj::DPAD_UP;

int XBOX_BUTTON_IDS_obj::DPAD_DOWN;

int XBOX_BUTTON_IDS_obj::DPAD_LEFT;

int XBOX_BUTTON_IDS_obj::DPAD_RIGHT;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_UP,"DPAD_UP");
	HX_MARK_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_DOWN,"DPAD_DOWN");
	HX_MARK_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_LEFT,"DPAD_LEFT");
	HX_MARK_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_RIGHT,"DPAD_RIGHT");
};
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_UP,"DPAD_UP");
	HX_VISIT_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_DOWN,"DPAD_DOWN");
	HX_VISIT_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_LEFT,"DPAD_LEFT");
	HX_VISIT_MEMBER_NAME(XBOX_BUTTON_IDS_obj::DPAD_RIGHT,"DPAD_RIGHT");
};
