...
Void BGSprite_obj::draw( ){
{
		...
		while(((i < l))){
			...
			struct _Function_2_1{
				inline static ::org::flixel::system::layer::DrawStackItem Block( ::org::flixel::system::BGSprite_obj *__this,bool &isColored,::org::flixel::FlxCamera &camera){
			...
			HX_STACK_LINE(65)
			drawItem = _Function_2_1::Block(this,isColored,camera);
			HX_STACK_LINE(69)
