...
{
HX_STACK_PUSH("FlxTimer::new","org/flixel/util/FlxTimer.hx",48);
{
	HX_STACK_LINE(49)
	this->time = (int)0;
	HX_STACK_LINE(50)
...
Float FlxTimer_obj::get_progress( ){
	HX_STACK_PUSH("FlxTimer::get_progress","org/flixel/util/FlxTimer.hx",167);
	HX_STACK_THIS(this);
	HX_STACK_LINE(167)
	if (((this->time > (int)0))){
		HX_STACK_LINE(169)
...
int FlxTimer_obj::get_loopsLeft( ){
	HX_STACK_PUSH("FlxTimer::get_loopsLeft","org/flixel/util/FlxTimer.hx",157);
	HX_STACK_THIS(this);
	HX_STACK_LINE(157)
...
Float FlxTimer_obj::get_timeLeft( ){
	HX_STACK_PUSH("FlxTimer::get_timeLeft","org/flixel/util/FlxTimer.hx",147);
	HX_STACK_THIS(this);
	HX_STACK_LINE(147)
...
{
		HX_STACK_PUSH("FlxTimer::stop","org/flixel/util/FlxTimer.hx",132);
		HX_STACK_THIS(this);
		HX_STACK_LINE(133)
		this->finished = true;
		HX_STACK_LINE(134)
...
::org::flixel::util::FlxTimer FlxTimer_obj::start( hx::Null< Float >  __o_Time,hx::Null< int >  __o_Loops,Dynamic Callback){
Float Time = __o_Time.Default(1);
int Loops = __o_Loops.Default(1);
	HX_STACK_PUSH("FlxTimer::start","org/flixel/util/FlxTimer.hx",104);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("FlxTimer::update","org/flixel/util/FlxTimer.hx",75);
		HX_STACK_THIS(this);
		HX_STACK_LINE(76)
...
{
		HX_STACK_PUSH("FlxTimer::destroy","org/flixel/util/FlxTimer.hx",63);
		HX_STACK_THIS(this);
		HX_STACK_LINE(64)
		this->stop();
		HX_STACK_LINE(65)
...
::org::flixel::plugin::TimerManager FlxTimer_obj::get_manager( ){
	HX_STACK_PUSH("FlxTimer::get_manager","org/flixel/util/FlxTimer.hx",181);
	HX_STACK_LINE(181)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxTimer_obj,get_manager,return )
...
Dynamic FlxTimer_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"timeLeft") ) { return inCallProp ? get_timeLeft() : timeLeft; }
		if (HX_FIELD_EQ(inName,"finished") ) { return finished; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"loopsLeft") ) { return inCallProp ? get_loopsLeft() : loopsLeft; }
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.util.FlxTimer"), hx::TCanCast< FlxTimer_obj> ,sStaticFields,sMemberFields,
