...
{
HX_STACK_PUSH("FlxRect::new","org/flixel/util/FlxRect.hx",36);
...
bool FlxRect_obj::overlaps( ::org::flixel::util::FlxRect Rect){
	HX_STACK_PUSH("FlxRect::overlaps","org/flixel/util/FlxRect.hx",162);
	HX_STACK_THIS(this);
...
::flash::geom::Rectangle FlxRect_obj::copyToFlash( ::flash::geom::Rectangle FlashRect){
	HX_STACK_PUSH("FlxRect::copyToFlash","org/flixel/util/FlxRect.hx",148);
	HX_STACK_THIS(this);
...
::org::flixel::util::FlxRect FlxRect_obj::copyFromFlash( ::flash::geom::Rectangle FlashRect){
	HX_STACK_PUSH("FlxRect::copyFromFlash","org/flixel/util/FlxRect.hx",134);
	HX_STACK_THIS(this);
	HX_STACK_ARG(FlashRect,"FlashRect");
	HX_STACK_LINE(135)
	this->x = FlashRect->x;
...
::org::flixel::util::FlxRect FlxRect_obj::copyTo( ::org::flixel::util::FlxRect Rect){
	HX_STACK_PUSH("FlxRect::copyTo","org/flixel/util/FlxRect.hx",120);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Rect,"Rect");
	HX_STACK_LINE(121)
	Rect->x = this->x;
...
::org::flixel::util::FlxRect FlxRect_obj::copyFrom( ::org::flixel::util::FlxRect Rect){
	HX_STACK_PUSH("FlxRect::copyFrom","org/flixel/util/FlxRect.hx",106);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Rect,"Rect");
	HX_STACK_LINE(107)
	this->x = Rect->x;
...
::org::flixel::util::FlxRect FlxRect_obj::make( hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,hx::Null< Float >  __o_Width,hx::Null< Float >  __o_Height){
Float X = __o_X.Default(0);
Float Y = __o_Y.Default(0);
Float Width = __o_Width.Default(0);
Float Height = __o_Height.Default(0);
	HX_STACK_PUSH("FlxRect::make","org/flixel/util/FlxRect.hx",92);
	HX_STACK_THIS(this);
	HX_STACK_ARG(X,"X");
	HX_STACK_ARG(Y,"Y");
...
Float FlxRect_obj::get_bottom( ){
	HX_STACK_PUSH("FlxRect::get_bottom","org/flixel/util/FlxRect.hx",79);
	HX_STACK_THIS(this);
	HX_STACK_LINE(79)
...
Float FlxRect_obj::get_top( ){
	HX_STACK_PUSH("FlxRect::get_top","org/flixel/util/FlxRect.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_LINE(69)
	return this->y;
}
...
Float FlxRect_obj::get_right( ){
	HX_STACK_PUSH("FlxRect::get_right","org/flixel/util/FlxRect.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_LINE(59)
...
Float FlxRect_obj::get_left( ){
	HX_STACK_PUSH("FlxRect::get_left","org/flixel/util/FlxRect.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
	return this->x;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.util.FlxRect"), hx::TCanCast< FlxRect_obj> ,sStaticFields,sMemberFields,
