...
Float Ease_obj::sineIn( Float t){
	...
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(84)
	return (-(::Math_obj::cos((::org::flixel::tweens::util::Ease_obj::PI2 * t))) + (int)1);
}
...
Float Ease_obj::sineOut( Float t){
	...
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(90)
	return ::Math_obj::sin((::org::flixel::tweens::util::Ease_obj::PI2 * t));
}
...
Float Ease_obj::sineInOut( Float t){
	...
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(96)
	return ((Float(-(::Math_obj::cos((::org::flixel::tweens::util::Ease_obj::PI * t)))) / Float((int)2)) + .5);
}
...
Float Ease_obj::bounceIn( Float t){
	...
	t = ((int)1 - t);
	HX_STACK_LINE(104)
	if (((t < ::org::flixel::tweens::util::Ease_obj::B1))){
		HX_STACK_LINE(104)
		return ((int)1 - ((7.5625 * t) * t));
	}
	HX_STACK_LINE(105)
	if (((t < ::org::flixel::tweens::util::Ease_obj::B2))){
		HX_STACK_LINE(105)
		return ((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) + .75)));
	}
	HX_STACK_LINE(106)
	if (((t < ::org::flixel::tweens::util::Ease_obj::B4))){
		HX_STACK_LINE(106)
		return ((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) + .9375)));
	}
	HX_STACK_LINE(107)
	return ((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) + .984375)));
}
...
Float Ease_obj::bounceOut( Float t){
	...
	if (((t < ::org::flixel::tweens::util::Ease_obj::B2))){
		HX_STACK_LINE(114)
		return (((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) + .75);
	}
	HX_STACK_LINE(115)
	if (((t < ::org::flixel::tweens::util::Ease_obj::B4))){
		HX_STACK_LINE(115)
		return (((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) + .9375);
	}
	HX_STACK_LINE(116)
	return (((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) + .984375);
}
...
Float Ease_obj::bounceInOut( Float t){
	...
	if (((t < .5))){
		...
		if (((t < ::org::flixel::tweens::util::Ease_obj::B2))){
			HX_STACK_LINE(126)
			return (Float((((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) + .75))))) / Float((int)2));
		}
		HX_STACK_LINE(127)
		if (((t < ::org::flixel::tweens::util::Ease_obj::B4))){
			HX_STACK_LINE(127)
			return (Float((((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) + .9375))))) / Float((int)2));
		}
		HX_STACK_LINE(128)
		return (Float((((int)1 - ((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) + .984375))))) / Float((int)2));
	}
	HX_STACK_LINE(130)
	t = ((t * (int)2) - (int)1);
	HX_STACK_LINE(131)
	...
	if (((t < ::org::flixel::tweens::util::Ease_obj::B2))){
		HX_STACK_LINE(132)
		return ((Float(((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) * ((t - ::org::flixel::tweens::util::Ease_obj::B3))) + .75))) / Float((int)2)) + .5);
	}
	HX_STACK_LINE(133)
	if (((t < ::org::flixel::tweens::util::Ease_obj::B4))){
		HX_STACK_LINE(133)
		return ((Float(((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) * ((t - ::org::flixel::tweens::util::Ease_obj::B5))) + .9375))) / Float((int)2)) + .5);
	}
	HX_STACK_LINE(134)
	return ((Float(((((7.5625 * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) * ((t - ::org::flixel::tweens::util::Ease_obj::B6))) + .984375))) / Float((int)2)) + .5);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.tweens.util.Ease"), hx::TCanCast< Ease_obj> ,sStaticFields,sMemberFields,
...
void Ease_obj::__boot()
{
	...
	EL= (Float(((int)2 * ::org::flixel::tweens::util::Ease_obj::PI)) / Float(.45));
