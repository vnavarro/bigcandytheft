...
{
		HX_STACK_PUSH("MultiVarTween::update","org/flixel/tweens/misc/MultiVarTween.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_LINE(82)
		this->super::update();
		HX_STACK_LINE(83)
...
Void MultiVarTween_obj::tween( Dynamic object,Dynamic properties,Float duration,Dynamic ease){
{
		...
		this->_object = object;
		HX_STACK_LINE(42)
		::org::flixel::util::FlxArray_obj::setLength(this->_vars,(int)0);
		HX_STACK_LINE(43)
		::org::flixel::util::FlxArray_obj::setLength(this->_start,(int)0);
		HX_STACK_LINE(44)
		::org::flixel::util::FlxArray_obj::setLength(this->_range,(int)0);
		HX_STACK_LINE(45)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.tweens.misc.MultiVarTween"), hx::TCanCast< MultiVarTween_obj> ,sStaticFields,sMemberFields,
