...
Float FlxTween_obj::get_scale( ){
	HX_STACK_PUSH("FlxTween::get_scale","org/flixel/tweens/FlxTween.hx",173);
	HX_STACK_THIS(this);
	HX_STACK_LINE(173)
	return this->_t;
}
...
Float FlxTween_obj::set_percent( Float value){
	HX_STACK_PUSH("FlxTween::set_percent","org/flixel/tweens/FlxTween.hx",170);
	HX_STACK_THIS(this);
...
Float FlxTween_obj::get_percent( ){
	HX_STACK_PUSH("FlxTween::get_percent","org/flixel/tweens/FlxTween.hx",169);
	HX_STACK_THIS(this);
	HX_STACK_LINE(169)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.tweens.FlxTween"), hx::TCanCast< FlxTween_obj> ,sStaticFields,sMemberFields,
