...
bool FlxSprite_obj::onScreen( ::org::flixel::FlxCamera Camera){
	...
	HX_STACK_ARG(Camera,"Camera");
	struct _Function_1_1{
		inline static bool Block( ::org::flixel::FlxSprite_obj *__this,::org::flixel::FlxCamera &Camera){
...
Void FlxSprite_obj::draw( ){
{
		...
		while(((i < l))){
			...
			struct _Function_2_2{
				inline static ::org::flixel::system::layer::DrawStackItem Block( ::org::flixel::FlxSprite_obj *__this,bool &isColored,::org::flixel::FlxCamera &camera){
			...
			HX_STACK_LINE(827)
			drawItem = _Function_2_2::Block(this,isColored,camera);
			HX_STACK_LINE(831)
