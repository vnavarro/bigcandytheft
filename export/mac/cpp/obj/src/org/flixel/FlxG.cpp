...
bool FlxG_obj::collide( ::org::flixel::FlxBasic ObjectOrGroup1,::org::flixel::FlxBasic ObjectOrGroup2,Dynamic NotifyCallback){
	...
	HX_STACK_ARG(NotifyCallback,"NotifyCallback");
	struct _Function_1_1{
		inline static bool Block( ::org::flixel::FlxBasic &ObjectOrGroup1,Dynamic &NotifyCallback,::org::flixel::FlxBasic &ObjectOrGroup2){
	...
	HX_STACK_LINE(1578)
	return _Function_1_1::Block(ObjectOrGroup1,NotifyCallback,ObjectOrGroup2);
}
...
void FlxG_obj::__boot()
{
	...
	LIBRARY_MAJOR_VERSION= HX_CSTRING("2");
	LIBRARY_MINOR_VERSION= HX_CSTRING("0.0-alpha.3");
