...
{
HX_STACK_PUSH("PxFontSymbol::new","org/flixel/plugin/pxText/PxFontSymbol.hx",30);
{
}
;
	return null();
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.plugin.pxText.PxFontSymbol"), hx::TCanCast< PxFontSymbol_obj> ,sStaticFields,sMemberFields,
