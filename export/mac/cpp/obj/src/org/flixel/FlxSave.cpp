...
{
HX_STACK_PUSH("FlxSave::new","org/flixel/FlxSave.hx",51);
{
	HX_STACK_LINE(51)
	this->destroy();
}
...
bool FlxSave_obj::checkBinding( ){
	HX_STACK_PUSH("FlxSave::checkBinding","org/flixel/FlxSave.hx",208);
	HX_STACK_THIS(this);
	HX_STACK_LINE(209)
	if (((this->_sharedObject == null()))){
		HX_STACK_LINE(211)
		::org::flixel::FlxG_obj::warn(HX_CSTRING("You must call FlxSave.bind()\nbefore you can read or write data."));
		HX_STACK_LINE(212)
		return false;
	}
	HX_STACK_LINE(214)
...
bool FlxSave_obj::onDone( int Result){
	HX_STACK_PUSH("FlxSave::onDone","org/flixel/FlxSave.hx",183);
	HX_STACK_THIS(this);
	...
	if (  ( _switch_1==::org::flixel::FlxSave_obj::PENDING)){
		HX_STACK_LINE(186)
		::org::flixel::FlxG_obj::warn(HX_CSTRING("FlxSave is requesting extra storage space."));
	}
	else if (  ( _switch_1==::org::flixel::FlxSave_obj::ERROR)){
		HX_STACK_LINE(188)
		::org::flixel::FlxG_obj::error(HX_CSTRING("There was a problem flushing\nthe shared object data from FlxSave."));
	}
	HX_STACK_LINE(192)
...
bool FlxSave_obj::erase( ){
	HX_STACK_PUSH("FlxSave::erase","org/flixel/FlxSave.hx",155);
	HX_STACK_THIS(this);
	HX_STACK_LINE(156)
...
int MinFileSize = __o_MinFileSize.Default(0);
	HX_STACK_PUSH("FlxSave::flush","org/flixel/FlxSave.hx",111);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(OnComplete,"OnComplete");
{
		...
		HX_STACK_LINE(144)
		return this->onDone((  (((result == ::flash::net::SharedObjectFlushStatus_obj::FLUSHED))) ? int(::org::flixel::FlxSave_obj::SUCCESS) : int(::org::flixel::FlxSave_obj::PENDING) ));
	}
}
...
int MinFileSize = __o_MinFileSize.Default(0);
	HX_STACK_PUSH("FlxSave::close","org/flixel/FlxSave.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_ARG(MinFileSize,"MinFileSize");
	HX_STACK_ARG(OnComplete,"OnComplete");
{
...
bool FlxSave_obj::bind( ::String Name){
	HX_STACK_PUSH("FlxSave::bind","org/flixel/FlxSave.hx",73);
	HX_STACK_THIS(this);
	...
	try{
		...
		if (__e.IsClass< ::flash::errors::Error >() ){
			...
			::flash::errors::Error e = __e;{
				HX_STACK_LINE(82)
				::org::flixel::FlxG_obj::error(HX_CSTRING("There was a problem binding to\nthe shared object data from FlxSave."));
				HX_STACK_LINE(83)
				this->destroy();
				HX_STACK_LINE(84)
				return false;
...
{
		HX_STACK_PUSH("FlxSave::destroy","org/flixel/FlxSave.hx",59);
		HX_STACK_THIS(this);
		HX_STACK_LINE(60)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.FlxSave"), hx::TCanCast< FlxSave_obj> ,sStaticFields,sMemberFields,
