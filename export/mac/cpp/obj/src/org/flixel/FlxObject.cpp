...
bool FlxObject_obj::onScreen( ::org::flixel::FlxCamera Camera){
	...
	struct _Function_1_1{
		inline static bool Block( ::org::flixel::FlxObject_obj *__this,::org::flixel::FlxCamera &Camera){
	...
	HX_STACK_LINE(925)
	return _Function_1_1::Block(this,Camera);
}
	...
	HX_STACK_ARG(Camera,"Camera");
{
		...
		struct _Function_1_1{
			inline static ::org::flixel::util::FlxPoint Block( ::org::flixel::FlxObject &object,::org::flixel::FlxCamera &Camera){
		...
		HX_STACK_LINE(888)
		::org::flixel::util::FlxPoint objectScreenPos = _Function_1_1::Block(object,Camera);		HX_STACK_VAR(objectScreenPos,"objectScreenPos");
		HX_STACK_LINE(889)
...
Void FlxObject_obj::drawDebugOnCamera( ::org::flixel::FlxCamera Camera){
{
		...
		HX_STACK_LINE(459)
		if (((bool((bool(!(_Function_1_1::Block(this,Camera))) || bool(!(Camera->visible)))) || bool(!(Camera->exists))))){
			HX_STACK_LINE(460)
			return null();
		}
		HX_STACK_LINE(465)
...
Void FlxObject_obj::draw( ){
{
		...
		while(((i < l))){
			...
			HX_STACK_LINE(437)
			if (((bool((bool(!(_Function_2_1::Block(this,camera))) || bool(!(camera->visible)))) || bool(!(camera->exists))))){
				HX_STACK_LINE(438)
				continue;
			}
			HX_STACK_LINE(441)
...
bool FlxObject_obj::separateX( ::org::flixel::FlxObject Object1,::org::flixel::FlxObject Object2){
	...
	if (((obj1delta != obj2delta))){
		...
		struct _Function_2_2{
			inline static ::org::flixel::util::FlxRect Block( Float &obj2delta,::org::flixel::FlxObject &Object2){
		...
		HX_STACK_LINE(1158)
		::org::flixel::util::FlxRect obj2rect = _Function_2_2::Block(obj2delta,Object2);		HX_STACK_VAR(obj2rect,"obj2rect");
		HX_STACK_LINE(1160)
...
bool FlxObject_obj::separateY( ::org::flixel::FlxObject Object1,::org::flixel::FlxObject Object2){
	...
	if (((obj1delta != obj2delta))){
		...
		Float obj2deltaAbs = (  (((obj2delta > (int)0))) ? Float(obj2delta) : Float(-(obj2delta)) );		HX_STACK_VAR(obj2deltaAbs,"obj2deltaAbs");
		struct _Function_2_1{
			inline static ::org::flixel::util::FlxRect Block( ::org::flixel::FlxObject &Object1,Float &obj1deltaAbs,Float &obj1delta){
		...
		HX_STACK_LINE(1268)
		::org::flixel::util::FlxRect obj1rect = _Function_2_1::Block(Object1,obj1deltaAbs,obj1delta);		HX_STACK_VAR(obj1rect,"obj1rect");
		struct _Function_2_2{
			inline static ::org::flixel::util::FlxRect Block( Float &obj2deltaAbs,Float &obj2delta,::org::flixel::FlxObject &Object2){
		...
		HX_STACK_LINE(1269)
		::org::flixel::util::FlxRect obj2rect = _Function_2_2::Block(obj2deltaAbs,obj2delta,Object2);		HX_STACK_VAR(obj2rect,"obj2rect");
		HX_STACK_LINE(1271)
		if (((bool((bool((bool(((obj1rect->x + obj1rect->width) > obj2rect->x)) && bool((obj1rect->x < (obj2rect->x + obj2rect->width))))) && bool(((obj1rect->y + obj1rect->height) > obj2rect->y)))) && bool((obj1rect->y < (obj2rect->y + obj2rect->height)))))){
			HX_STACK_LINE(1273)
			Float maxOverlap = ((obj1deltaAbs + obj2deltaAbs) + ::org::flixel::FlxObject_obj::SEPARATE_BIAS);		HX_STACK_VAR(maxOverlap,"maxOverlap");
