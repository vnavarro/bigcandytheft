...
Void URLLoader_obj::update( ){
{
		...
		if (((this->__handle != null()))){
			...
			HX_STACK_LINE(157)
			::flash::net::URLLoader_obj::nme_curl_update_loader(this->__handle,hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(159)
			...
			HX_STACK_LINE(171)
			int code = ::flash::net::URLLoader_obj::nme_curl_get_code(this->__handle);		HX_STACK_VAR(code,"code");
			HX_STACK_LINE(173)
			if (((this->state == (int)3))){
				HX_STACK_LINE(175)
				...
				if (((code < (int)400))){
					HX_STACK_LINE(179)
					::flash::utils::ByteArray bytes = ::flash::net::URLLoader_obj::nme_curl_get_data(this->__handle);		HX_STACK_VAR(bytes,"bytes");
					HX_STACK_LINE(181)
					{
						HX_STACK_LINE(181)
				...
				if (((this->state == (int)4))){
					...
					this->dispatchHTTPStatus(code);
					HX_STACK_LINE(204)
					::flash::events::IOErrorEvent event = ::flash::events::IOErrorEvent_obj::__new(::flash::events::IOErrorEvent_obj::IO_ERROR,true,false,::flash::net::URLLoader_obj::nme_curl_get_error_message(this->__handle),code);		HX_STACK_VAR(event,"event");
					HX_STACK_LINE(205)
					this->__handle = null();
					HX_STACK_LINE(206)
					this->dispatchEvent(event);
...
Void URLLoader_obj::load( ::flash::net::URLRequest request){
{
		...
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			...
			request->__prepare();
			HX_STACK_LINE(119)
			this->__handle = ::flash::net::URLLoader_obj::nme_curl_create(request);
			HX_STACK_LINE(121)
			if (((this->__handle == null()))){
				HX_STACK_LINE(121)
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(61)
	return ::flash::net::URLLoader_obj::nme_curl_get_cookies(this->__handle);
}
...
Void URLLoader_obj::initialize( ::String caCertFilePath){
{
		...
		HX_STACK_LINE(75)
		::flash::net::URLLoader_obj::nme_curl_initialize(caCertFilePath);
	}
return null();
}
...
Void URLLoader_obj::__pollData( ){
{
		...
		if ((!(::flash::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_STACK_LINE(251)
			::flash::net::URLLoader_obj::nme_curl_process_loaders();
			HX_STACK_LINE(252)
...
void URLLoader_obj::__boot()
{
	...
	urlComplete= (int)3;
	urlError= (int)4;
	nme_curl_create= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_create"),(int)1);
	nme_curl_process_loaders= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_process_loaders"),(int)0);
	nme_curl_update_loader= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_update_loader"),(int)2);
	nme_curl_get_code= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_get_code"),(int)1);
	nme_curl_get_error_message= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_get_error_message"),(int)1);
	nme_curl_get_data= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_get_data"),(int)1);
	nme_curl_get_cookies= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_get_cookies"),(int)1);
	nme_curl_initialize= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_curl_initialize"),(int)1);
}
