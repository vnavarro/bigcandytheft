...
{
HX_STACK_PUSH("LoaderInfo::new","flash/display/LoaderInfo.hx",35);
{
	HX_STACK_LINE(37)
...
::flash::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_PUSH("LoaderInfo::get_bytes","flash/display/LoaderInfo.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
	return this->data;
}
...
{
		HX_STACK_PUSH("LoaderInfo::this_onComplete","flash/display/LoaderInfo.hx",96);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("LoaderInfo::load","flash/display/LoaderInfo.hx",65);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static ::String Block( ::flash::display::LoaderInfo_obj *__this,::String &extension){
				HX_STACK_PUSH("*::closure","flash/display/LoaderInfo.hx",71);
				{
					HX_STACK_LINE(71)
...
::flash::display::LoaderInfo LoaderInfo_obj::create( ::flash::display::Loader loader){
	HX_STACK_PUSH("LoaderInfo::create","flash/display/LoaderInfo.hx",49);
