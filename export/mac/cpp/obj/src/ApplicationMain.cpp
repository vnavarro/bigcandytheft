...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(34)
		::flash::Lib_obj::setPackage(HX_CSTRING("Zaphod"),HX_CSTRING("BigCandyTheft"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));

		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",89);
			{
				HX_STACK_LINE(92)
		...
		HX_STACK_LINE(88)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)832,(int)640,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("BigCandyTheft"),null(),null());
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMain::applyScale","ApplicationMain.hx",182);
		HX_STACK_ARG(_,"_");
		HX_STACK_LINE(184)
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	HX_STACK_PUSH("ApplicationMain::getAsset","ApplicationMain.hx",230);
