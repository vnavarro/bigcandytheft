...
class HXCPP_CLASS_ATTRIBUTES  TimerManager_obj : public ::org::flixel::FlxBasic_obj{
	public:
	...
	public:
		...
		virtual Void remove( ::org::flixel::util::FlxTimer Timer);
		Dynamic remove_dyn();

		virtual Void add( ::org::flixel::util::FlxTimer Timer);
		Dynamic add_dyn();
