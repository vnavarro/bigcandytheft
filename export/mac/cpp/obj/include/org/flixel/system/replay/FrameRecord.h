...
class HXCPP_CLASS_ATTRIBUTES  FrameRecord_obj : public hx::Object{
	...
	public:
		...
		virtual ::org::flixel::system::replay::FrameRecord create( Float Frame,Array< ::Dynamic > Keys,::org::flixel::system::replay::MouseRecord Mouse);
		Dynamic create_dyn();

		::org::flixel::system::replay::MouseRecord mouse;
		Array< ::Dynamic > keys;
		int frame;
};
