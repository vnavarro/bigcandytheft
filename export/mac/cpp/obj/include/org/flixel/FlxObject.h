...
class HXCPP_CLASS_ATTRIBUTES  FlxObject_obj : public ::org::flixel::FlxBasic_obj{
	...
	public:
		...
		static int WALL;
		static int ANY;
		static int PATH_FORWARD;
		static int PATH_BACKWARD;
		static int PATH_LOOP_FORWARD;
		static int PATH_LOOP_BACKWARD;
		static int PATH_YOYO;
		static int PATH_HORIZONTAL_ONLY;
		static int PATH_VERTICAL_ONLY;
